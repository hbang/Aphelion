...
- (NSString *)description {
	return [NSString stringWithFormat:@"<%@: %p; type = %u; range = %@; replacement = %@; url = %@; userID = %@>", NSStringFromClass(self.class), self, _type, NSStringFromRange(_range), _replacement, _url, _userID];
}
